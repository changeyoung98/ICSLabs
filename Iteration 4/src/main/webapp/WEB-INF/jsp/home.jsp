...
<div class="container" id="bookMainContainer">
    <div class="alert alert-info fade in" role="alert"><span class="glyphicon glyphicon-time"></span> Loading book info...</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="detailDialogLabel">Book details</h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <textarea class="form-control" rows="5" id="bookDetailDescription" placeholder="No book introduction"  readonly></textarea>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                <form class="form-inline pull-left">
                    <div class="form-group">
                        <label for="addQuantity">Amount</label>
                        <input type="number" class="form-control" id="addQuantity" min="1">
                    </div>
                    <button type="button" class="btn btn-success" id="btnAddToCart">Add to the shopping cart</button>
                </form>
