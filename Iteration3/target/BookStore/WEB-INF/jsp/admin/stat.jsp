...
<div class="container">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4 class="panel-title">Filter According to Category</h4>
        </div>
        <div class="panel-body">
            <form class="form-inline">
                ...
                <button type="button" class="btn btn-primary" id="btnFilterCategory">Filter</button>    
            </form>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4 class="panel-title">Filter According to Book</h4>
        </div>
        <div class="panel-body">
            <form class="form-inline">
                <input type="number" class="form-control" min="1" placeholder="Book ID" id="filterBook">
                <input type="date" class="form-control" id="filterBookStartDate">
                -
                <input type="date" class="form-control" id="filterBookEndDate">
                <button type="button" class="btn btn-primary" id="btnFilterBook">Filter</button>    
            </form>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4 class="panel-title">Filter According to User</h4>
        </div>
        <div class="panel-body">
            <form class="form-inline">
                <input type="text" class="form-control" placeholder="User Name" id="filterUser">
                <input type="date" class="form-control" id="filterUserStartDate">
                -
                <input type="date" class="form-control" id="filterUserEndDate">
                <button type="button" class="btn btn-primary" id="btnFilterUser">Filter</button>    
            </form>
